...
if (!apiKey) {
  ...
  console.log(
    '   - Database: "databases.read", "databases.write", "documents.read", "documents.write"',
  );
  console.log('   - Auth / Users: "users.read", "users.write"');
  console.log(
    '4. Add APPWRITE_API_KEY="your_key_here" to your .env file and re-run: npm run setup:db\n',
  );
  process.exit(1);
}
...
const COLLECTION_ID =
  process.env.VITE_APPWRITE_RECRUITMENT_COLLECTION_ID || "recruitment_applications";
